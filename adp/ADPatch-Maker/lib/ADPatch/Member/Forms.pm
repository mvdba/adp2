...
ADPatch::Member::Forms - The great new ADPatch::Member::Forms!
...
Perhaps a little code snippet.
    ...
    use ADPatch::Member::Forms;

    my $foo = ADPatch::Member::Forms->new();
    ...
...
C<bug-adpatch-member-forms at rt.cpan.org>, or through the web interface at
