...
ADPatch::Utils - Utility routines for ADPatch::Maker.
...
Grouping sub-programs...

Perhaps a little code snippet.

    use ADPatch::Utils;

    my $foo = ADPatch::Utils->new();
    ...
...
C<bug-adpatch-utils at rt.cpan.org>, or through the web interface at
